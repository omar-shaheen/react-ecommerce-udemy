            ...
            <Row>
              <Col className="p-2" lg={3} md={3} sm={6}>
                ...
                <a className="facebook social">
                  <i className="fab mt-4 m-2 h4 fa-facebook"></i>
                </a>
                <a className="facebook social">
                  <i className="fab m-2 h4 fa-instagram"></i>
                </a>
                <a className="facebook social">
                  <i className="fab m-2 h4 fa-twitter"></i>
                </a>
                <a className="facebook social">
                  <i className="fab m-2 h4 fa-linkedin"></i>
                </a>
                <a className="facebook social">
                  <i className="fab m-2 h4 fa-youtube"></i>
                </a>
              </Col>
              <Col className="p-2" lg={3} md={3} sm={6}>
                <h5 className="footer-menu-title">More Information </h5>
                <a className="footer-link">purchase policy</a>
                <br></br>
                <a className="footer-link"> Privcey policy</a>
                <br></br>
              ...
              <Col className="p-2" lg={3} md={3} sm={6}>
                ...
                <p className="address">
                  1765 Zafer Street - near the city of center
                </p>
                <span className="address">
                  
                  <i className="fa fa-envelope"></i> info@ctp.com
                </span>
              </Col>
            </Row>
            ...
            <Container>
              <Row>
                <h6 className="address">
                  All Rights is reserved for ctp 2022
                </h6>
              </Row>
            </Container>
          </Container>
